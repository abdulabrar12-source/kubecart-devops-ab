...
public sealed class AppConfig
{
    ...
    // ── Downstream services ──────────────────────────────────────────────────
    /// <summary>Base URL of catalog-service (env: CATALOG_SERVICE_URL).</summary>
    public string CatalogServiceUrl { get; }

    private AppConfig(string dbName, string connectionString, string catalogServiceUrl)
    {
        DbName           = dbName;
    ...
    public static AppConfig Load()
    {
        ...
        var dbName     = Optional("DB_NAME", "KubeCart_Orders");
        ...
        var catalogServiceUrl = Require("CATALOG_SERVICE_URL");

        return new AppConfig(dbName, connectionString, catalogServiceUrl);
    }
